...
<spring:url value="/resources/images" var="urlPublic"></spring:url>
		...
		<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
		  <div class="carousel-inner">
		    <div class="carousel-item active">
		      <img src="<c:url value="/resources/images/2.jpg" />" class="d-block w-100" alt="..." >
		    </div>
		    <div class="carousel-item">
		      <img src="<c:url value="/resources/images/3.jpg" />" class="d-block w-100" alt="..." >
		    </div>
		  </div>
		...
		<div class="row">
			<div class="col-6">
				<div class="" style="text-align:center;">
					<a href="/example/menCategory" ><img src="<c:url value="/resources/images/2-1.jpg" />" ></a>
					<h3 style="margin-top:-27%;">Para Ellos</h3>
				</div>
			</div>
			<div class="col-6">
				<div class="" style="text-align:center;">
					<img src="<c:url value="/resources/images/1.11.jpg" />" >
					<h3 style="margin-top:-27%;">Para Ellas</h3>
				</div>
			</div>
		</div>
